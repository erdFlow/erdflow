...
export const SHOW_DOCUMENT_VIEW_LABEL = "Document View"
...
export const DOCUMENT_VIEW_EMPTY_LABEL = "Select a collection to view schema"
export const DOCUMENT_VIEW_EMPTY_DESCRIPTION =
  "Click a collection on the canvas or in the sidebar."
export const SQL_VIEW_COPY_LABEL = "Copy SQL"
export const DOCUMENT_VIEW_COPY_LABEL = "Copy schema"
export const SQL_VIEW_COPIED_LABEL = "Copied"
export const SQL_VIEW_CLOSE_LABEL = "Close SQL View"
export const DOCUMENT_VIEW_CLOSE_LABEL = "Close Document View"
export const SETTINGS_LABEL = "Settings"
export const CLEAR_CACHE_LABEL = "Clear cache"
