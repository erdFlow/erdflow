...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Persist sidebar open state across reloads (shadcn pattern).
      // biome-ignore lint/suspicious/noDocumentCookie: intentional cookie persistence for sidebar UI state
